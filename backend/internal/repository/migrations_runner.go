...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// 157 was edited across two upstream merges (both union kiro+grok into the
	// user_platform_quotas platform CHECK); DBs that applied the earlier fork
	// edit (c98d...) must boot against the current upstream2 version (a918...).
	"157_user_platform_quotas_add_grok.sql": newMigrationChecksumCompatibilityRule("a918734da39c2e5a82e4a5e9511bac1f4cf7e310ceadd647df52692320633c1b", "c98d69cc5d1d124bdfaf182e7d66c4696a72ffc8c7f2ede946b5c1d9b9814f26"),
